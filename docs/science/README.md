...
Étudiée puis mise de côté (2026-09-09) : concentration plasmatique estimée en mg/L (`C = A / (0,67 L/kg × poids)`, synthèse §7 — mêmes seuils, repères de toxicité 15/50/80 mg/L informatifs ; calculs conservés dans `KaffCore`, non affichés). Faites en v0.2 (M6, 2026-09-06) : heure de coucher réelle lue dans `sleepAnalysis` (médiane circulaire des
