...
@Test func widgetEntryDatesArePinned() {
    ...
    // 250 mg à 08:00 : pic haut à 08:21 (1786350060), retombe sous 200 mg à 09:49 (1786355340). Seuil de coucher
    // 35 mg (M5.6) : « prêt à dormir » à 250 × 1,0285 × e^(−0,13863·t) < 35 → t ≈ 14,4 h → 22:24, hors horizon
    // (l'ancienne transition 19:49 à 50 mg disparaît).
